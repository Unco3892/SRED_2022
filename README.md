...
[![DOI](https://img.shields.io/badge/DOI-10.3390/bdcc6030096-blue)](https://doi.org/10.3390/bdcc6030096) [![Dataset](https://img.shields.io/badge/Dataset-Download-brightgreen)](https://github.com/Unco3892/SRED_2022/releases/download/v1.0/SRED_data.zip) [![License: CC BY-NC-SA 4.0](https://img.shields.io/badge/License-CC%20BY--NC--SA%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by-nc-sa/4.0/)
...
The Swiss Real Estate Dataset (SRED) is a multi-modal dataset of 11,105 flat rental listings scraped from a Swiss real estate platform during February and March 2021.

The dataset can be downloaded [here](https://github.com/Unco3892/SRED_2022/releases/download/v1.0/SRED_data.zip).
